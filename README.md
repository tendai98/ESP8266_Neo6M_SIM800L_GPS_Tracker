...
Hardware troubleshooting
	...
	•	ESP resets → too many Strings or serial flooding; the provided modem code avoids this.
...
→ { "items": [{ "id": "AGR 9021", "vehicleId": "TRUCK-01", "lastSeenTs": 1757753440409, "ip": "1.2.3.4" }] }
	•	GET /api/devices/:id
→ { "device": { "vehicleId": "TRUCK-01", "lastSeenTs": 1757753440409, "ip": "1.2.3.4" }, "latest": { "vId": "TRUCK-01", "lt": -17.821234, "ln": 31.051111, "s": 22.3, "h": 90, "ts": 1757753440409, "ip": "1.2.3.4" } }
...
# ESP8266_Neo6M_SIM800L_GPS_Tracker
